@extends('app')
@section('title',"Multiplicar dos números")
@section('content')
        ...
        <div class="card bg-dark text-white" style="border-radius: 1rem;">
          <div class="card-body p-5 text-center">
            ...
            <div class="mb-md-5 mt-md-4 pb-5">
              ...
              <h2 class="fw-bold mb-2 text-uppercase">Multiplicación</h2>
              <p class="text-white-50 mb-5">Introduce dos números para multiplicar</p>
